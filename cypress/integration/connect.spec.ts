  ...
  it("Lets user connect with Metamask provider", () => {
    cy.visit("/faucet", {
      onBeforeLoad(win) {
        ...
        // win.localStorage.setItem("metamask", JSON.stringify({
        //   config: null,
        //   address: "0x3256a804085C24f3451cAb2C98a37e16DEEc5721",
        //   tokenBalance: null,
        //   tx: null
        // }));
      }
    ...
    cy.window().then((win) => {
      win.ethereum.changeCurrentAddress("0xd3b5586D15140B6f793b260fd90588A0dAefc5B6");
    });
